...
namespace ReapalDDD
{
    public class XmlConfig
    {
        ...
        private static XmlHelper xml
        {
            get
            {
                return new XmlHelper(@"C:\_Config\CgtConfig.xml");
            }
        }
        #region 融宝api
        /// <summary>
        /// 用户key
        /// </summary>
        public static string ReapalUserKey
        {
            get
            {
                return xml.ReadNodeListTxt("ReapalUserKey");
            }
        }
        ...
        public static string ReapalMerchantId
        {
            get
            {
                return xml.ReadNodeListTxt("ReapalMerchantId");
            }
        }
        ...
        /// 公钥
        /// </summary>
        public static string ReapalPublicKeyCerUrl
        {
            get
            {
                return xml.ReadNodeListTxt("ReapalPublicKeyCerUrl");
            }
        }
        ...
        /// 私钥
        /// </summary>
        public static string ReapalPrivateKeyPfxUrl
        {
            get
            {
                return xml.ReadNodeListTxt("ReapalPrivateKeyPfxUrl");
            }
        }
        ...
        /// RSA密码
        /// </summary>
        public static string ReapalRSAPwd
        {
            get
            {
                return xml.ReadNodeListTxt("ReapalRSAPwd");
            }
        }
        #endregion
    }
    ...
    public class XmlHelper
    {
        ...
        #region 读取数据
        public string ReadNodeListTxt(string node)
        {
            string value = "";
            try
            {
                XmlDocument doc = XMLLoad();
                XmlNodeList xn = doc.DocumentElement.SelectNodes(node);
                value = xn[0].InnerXml.ToString().Replace("\r\n", "").Trim();
            }
            catch { }
            return value;
        }
